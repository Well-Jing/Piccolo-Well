...
namespace Piccolo
{
    void CustomVFXPass::initialize(const RenderPassInitInfo* init_info)
    {
        RenderPass::initialize(nullptr);

        const CustomVFXPassInitInfo* _init_info = static_cast<const CustomVFXPassInitInfo*>(init_info);
    ...
    void CustomVFXPass::setupDescriptorSetLayout()
    {
    ...
    void CustomVFXPass::setupPipelines()
    {
        ...
        RHIShader* frag_shader_module = m_rhi->createShaderModule(CUSTOM_VFX_FRAG);
    ...
    void CustomVFXPass::setupDescriptorSet()
    {
    ...
    void CustomVFXPass::updateAfterFramebufferRecreate(RHIImageView* input_attachment)
    {
    ...
    void CustomVFXPass::draw()
    {
        float color[4] = { 1.0f, 1.0f, 1.0f, 1.0f };
        m_rhi->pushEvent(m_rhi->getCurrentCommandBuffer(), "Custom VFX", color);
